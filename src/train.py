...
layout = []
layout.add( ('conv2D', {'nb_filter': 100, 'nb_row': 7, 'nb_col': 7, 'init': 'uniform', 'activation': 'tanh', 'input_shape': input_shape}) )
layout.add( ('maxpool2D', {'pool_size': (2,2)}) )
layout.add( ('conv2D', {'nb_filter': 150, 'nb_row': 4, 'nb_col': 4, 'init': 'uniform', 'activation': 'tanh'}) )
layout.add( ('maxpool2D', {'pool_size': (2,2)}) )
layout.add( ('conv2D', {'nb_filter': 250, 'nb_row': 4, 'nb_col': 4, 'init': 'uniform', 'activation': 'tanh'}) )
layout.add( ('maxpool2D', {'pool_size': (2,2)}) )
layout.add( ('flatten', None) )
layout.add( ('dense', {'output_dim': 300, 'init': 'uniform', 'activation': 'tanh'}) )
layout.add( ('dense', {'output_dim': num_classes, 'init': 'uniform', 'activation': 'softmax'}) )
