...
\definecolor{ItalianGreen}{rgb}{0,0.5725,0.2745}
\definecolor{ItalianRed}{rgb}{0.8078,0.1686,0.2156}
...
\frame[<+->]{
	...
	\begin{itemize}
		\item What is a Convolutional Neural Network?
