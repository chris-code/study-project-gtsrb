...
\frame{
	\frametitle{INRIA --- How do the original filters look like?}
	\begin{textblock*}{1.1\textwidth}(0.3cm,1.3cm)
		\begin{figure}
			\centering
...
\frame{
	...
	\begin{itemize}
		...
		\item GTSRB (and INRIA) filters generalize well and can be used to construct reliable classifiers fast.
	\end{itemize}
}
