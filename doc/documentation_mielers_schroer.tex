...
%Although the results on the COIL100 dataset seem to confirm this assumption, we will also consider a probably more difficult dataset in chapter \ref{subsec:inria} in order to alleviate the probability of having achieved our results only owing to unfortunate circumstances like noise or a too simple problem.
