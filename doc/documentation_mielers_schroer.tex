...
%TODO not "serveral epochs", how many?
...
% TODO WHICH GTSRB network? morph or no morph? relu?
% TODO might also be unclear in the corresponding COIL100 section
...
% If it was trained for 60 epochs, why are only 30 shown in the plot?
...
% TODO I think that the INRIA filters actually look a bit more noisy than the GTSRB ones (but not as much as the COIL100 ones of course)
