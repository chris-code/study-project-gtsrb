...
\begin{appendix}
	...
	In order to create an indication for the generalization behaviour of the filters, the filters of the convolutional layers were visualized graphically.
	\begin{figure}[h!]
		\centering
		\includegraphics[width=1\textwidth]{weights_on_layer_0_horizontally_epoch_12_morph.png}
